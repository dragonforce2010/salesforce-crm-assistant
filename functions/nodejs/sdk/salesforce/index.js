...
const { LOGIN_URL, SALESFORCE_INSTANCE_URL, CLIENT_ID, CLIENT_SECRET, SALESFORCE_USERNAME, SALESFORCE_PASSWORD, TOKEN_REDIS_KEY_PREFIX } = require('./constant')
...
const getTokenFromRedis = async (context, logger) => {
  const tokenData = await baas.redis.get(`${TOKEN_REDIS_KEY_PREFIX}_${context.user._id}`)
  return tokenData
}
